...
// // ==============
// // Adagrams Object version (This will make `npm run demo-game` command work in terminal!)
// // For this case, I need to change the `adagram.test.js` file again! (from class to object)
// // ============== 
